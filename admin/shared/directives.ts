...
export const DIRECTIVE_DEFS: DirectiveDef[] = [
  ...
  { id: 'audio', name: 'audio', kind: 'container', icon: '🎵', params: [{ key: 'src', label: '音频路径', labelKey: 'dirParamAudioSrc', placeholder: 'assets/bgm.mp3', asset: true }, { key: 'title', label: '标题', labelKey: 'dirParamAudioTitle', placeholder: 'Aria' }, { key: 'description', label: '描述', labelKey: 'dirParamAudioDesc', placeholder: 'Goldberg Variations' }, { key: 'cover', label: '封面', labelKey: 'dirParamAudioCover', placeholder: 'assets/goldberg-aria-cover.jpg', asset: true }] },
  ...
  { id: 'mermaid', name: 'mermaid', kind: 'container', icon: '📊', params: [] },
...
export const INSERT_SNIPPETS: Record<string, string> = {
  ...
  audio: ':::audio{src="assets/bgm.mp3" title=""}\n:::\n',
